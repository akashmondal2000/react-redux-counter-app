...
createSlice({
  ...
  reducers:{
    ...
    /*2. these methods will be called for you by redux and they will recive the current "state".
    also to the "action", we will use that in a second parameter */
